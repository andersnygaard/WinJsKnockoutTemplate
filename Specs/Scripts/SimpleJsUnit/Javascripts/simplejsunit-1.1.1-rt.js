...
(function (window) {
    ...
    // simpleJsUnit core
    window.simpleJsUnit = new function () {
        ...
        // Type checking
        this.typeOf = function (something) {
        ...
        this.checkType = function (actual, expected, exception) {

            if (this.typeOf(actual) !== expected) {
    ...
    window.assert = {
        throwsException: function (fn, message) {
            ...
            // Check input
            simpleJsUnit.checkType(fn, "Function", "Invalid input parameter 'fn', expected function but got " + simpleJsUnit.typeOf(fn).toLowerCase());
        ...
        isTrue: function (actual, message) {
            ...
            // Check input
            simpleJsUnit.checkType(actual, "Boolean", "Invalid input parameter 'actual', expected boolean but got " + simpleJsUnit.typeOf(actual).toLowerCase());
        ...
        isInstanceOfType: function (actual, expected, message) {
            ...
            // Check input
            simpleJsUnit.checkType(expected, "String", "Invalid input parameter 'exptected', expected string but got " + simpleJsUnit.typeOf(expected).toLowerCase());

            // Assert
            if (simpleJsUnit.typeOf(actual).toLowerCase() !== expected.toLowerCase()) {
                if (message)
                    throw message.toString();
                else
    ...
    window.tests = {
        ...
        setup: {
            ...
            add: function (testgroup, fn) {
                ...
                // Check input
                simpleJsUnit.checkType(testgroup, "String", "Invalid input, testGroup is not of type 'String'");
                simpleJsUnit.checkType(fn, "Function", "Invalid input, fn is not of type 'Function'");
                ...
                // Add to log
                simpleJsUnit.log("Setup function added to '" + testgroup + "' test group");
            }
        },
        tearDown: {
            _tearDown: [],
            add: function (testgroup, fn) {
                ...
                // Add to log
                simpleJsUnit.log("Teardown function added to '" + testgroup + "' test group");
            }
        },
        add: function (testGroup, fn) {
            ...
            // Add to log
            simpleJsUnit.log("Test added to '" + testGroup + "' test group");
        },
        clear: function () {
            this._tests = [];
        },
        run: function () {
            ...
            testResults.time = (new Date() - startDate).toString() + " ms";

            // Add to log
            simpleJsUnit.log(testResults.run.toString() + " test(s) run in " + testResults.time + ". " + testResults.passed.toString() + " test(s) passed, " + testResults.failed.toString() + " test(s) failed");
